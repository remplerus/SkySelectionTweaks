...
public class BaseFreezerMenu extends AbstractContainerMenu {
    private final BaseFreezerBlockEntity blockEntity;
    ...
    public BaseFreezerMenu(int pContainerId, Inventory pInventory, BlockEntity container, ContainerData data) {
        super(SkySelMenus.MINI_FREEZER.get(), pContainerId);
        checkContainerSize(pInventory, 2);
        blockEntity = (BaseFreezerBlockEntity) container;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, SkySelBlocks.MINI_FREEZER.get());
    }
